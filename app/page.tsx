...
const DEFAULT_CONTENT = [
  ...
  "</ol>",
  "<blockquote>Remember: a concise plan keeps the team focused and aligned.</blockquote>",
  "<p>You can customise this content freely—format headings, change colours, align text, and export an exact PDF replica of what you see.</p>",
].join("");
